						...
						<div class="card-body">
							<div class="row">
								<?php if ($presensi->presensiMasuk != null) : ?>
									<div class="col-md-6">
										<img src="<?= base_url('uploads/presensi/') . $presensi->pictureMasuk; ?>" alt="Picture Presensi Masuk" class="img-thumbnail" width="200">
									</div>
									<div class="col-md-6">
						...
						<div class="card-body">
							<div class="row">
								<?php if ($presensi->presensiPulang != null) : ?>
									<div class="col-md-6">
										<img src="<?= base_url('uploads/presensi/') . $presensi->picturePulang; ?>" alt="Picture Presensi Pulang" class="img-thumbnail" width="200">
									</div>
									<div class="col-md-6">
										<table class="table table-bordered" width="100%" cellspacing="0">
											<thead>
			...
			<?php else : ?>
				<div class="col-lg-6">
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-6 bg-secondary text-center">
